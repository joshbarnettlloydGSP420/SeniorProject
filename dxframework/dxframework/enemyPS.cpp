...
enemyPS::enemyPS(const std::string& fxName, 
...
float enemyPS::getTime()
{
	return mTime;
}


void enemyPS::setTime(float t)
{
	mTime = t;
}

const AABB& enemyPS::getAABB()const
{
	return mBox;
}

void enemyPS::setWorldMtx(const D3DXMATRIX& world)
{
	mWorld = world;

...
float3 DiffuseLightDirection = float3(1, 0, 0); //float3(1, 0, 0);
 
// The color of the diffuse light
float4 DiffuseColor = float4(0.5, 0.5, 0.5, 1); //float4(1, 1, 1, 1);
 
// The intensity of the diffuse light
float DiffuseIntensity = 5.0; //1.0;

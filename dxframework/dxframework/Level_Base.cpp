	...
	case 1:
		{
			...
			Puzzle_C->Update( dt, eyePos, lookAt );
			Puzzle_C->BulletCollision( dt, player, bulletColor);
			puzzleSolved = Puzzle_C->getShattered();
			break;
		}
	case 2:
		{
	...
	case 1:
		{
			...
			Puzzle_C->Render( hwnd, eyePos, veiwMat, projMat );
			break;
		}
	case 2:
		{

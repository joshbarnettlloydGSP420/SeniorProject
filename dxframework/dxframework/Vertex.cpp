...
void InitAllVertexDeclarations()
{
	...
	HR(m_pD3DDevice->CreateVertexDeclaration(VertexPosElements, &VertexPos::Decl));
	...
	HR(m_pD3DDevice->CreateVertexDeclaration(VertexColElements, &VertexCol::Decl));
	...
	HR(m_pD3DDevice->CreateVertexDeclaration(VertexPNElements, &VertexPN::Decl));
	...
	HR(m_pD3DDevice->CreateVertexDeclaration(VertexPNTElements, &VertexPNT::Decl));
	...
	HR(m_pD3DDevice->CreateVertexDeclaration(ParticleElements, &Particle::Decl));
}

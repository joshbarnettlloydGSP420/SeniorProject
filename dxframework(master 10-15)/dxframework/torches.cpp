...
void FourTorchPuzzle::Init( Object_Player* Player, RenderObject* renderer, hkpWorld* world )
{
	...
	// torch positions
	Torches[0]->position = D3DXVECTOR4(20.6f, 3.0f, -17.6f, 0.0f); // northeast corner
	Torches[1]->position = D3DXVECTOR4(20.6f, 3.0f, -31.75f, 0.0f); // southeast corner // 23.7
	Torches[2]->position = D3DXVECTOR4(-18.2f, 3.0f, -17.6f, 0.0f); // northwest corner // -16
	Torches[3]->position = D3DXVECTOR4(-18.2f, 3.0f, -31.75f, 0.0f); // southwest corner
